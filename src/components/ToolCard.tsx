...
export default function ToolCard({ tool, showAlternativeCount, alternativeCount }: ToolCardProps) {
  return (
    <div className="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg hover:border-cyan-400 transition-all duration-200">
      {/* Image */}
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <span className="inline-flex items-center rounded-full bg-indigo-50 text-indigo-700 text-xs font-medium px-2 py-0.5">
            {tool.category}
          </span>
        ...
        <Link
          ...
          className="block w-full text-center text-sm font-medium text-cyan-600 hover:text-white bg-cyan-50 hover:bg-cyan-600 border border-cyan-200 hover:border-cyan-600 rounded-lg py-2 transition-all duration-200 hover:-translate-y-px hover:shadow"
        >
          詳細を見る
        </Link>
      </div>
